...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand navbar-dark bg-dark static-top">
            ...
            <a class="navbar-brand mr-1" href="ShowInquiryServlet">Wedding Bells</a>
            <a class="navbar-brand" href="ShowInquiryServlet">
                ...
                <table class="table table-striped table-dark">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><%out.println(category.getPhonenum());%></td>
                            <td><%out.println(category.getMsg());%></td>
                        </tr>
