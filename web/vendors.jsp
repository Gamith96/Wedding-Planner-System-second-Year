<%-- 
    Document   : vendors
    Created on : Dec 18, 2018, 9:34:46 AM
    Author     : Gamith
--%>
...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand navbar-dark bg-dark static-top">
            ...
            <a class="navbar-brand mr-1" href="vendors.jsp"><h3>Wedding Bells</h3></a>
            <a class="navbar-brand" href="vendors.jsp">
         ...
         <% }
                %>
                    ...
                    <li class="nav-item active">
                        <a class="nav-link" href="vendors.jsp">Vendors<span class="sr-only">(current)</span></a>
                    </li>
                    <li class="nav-item">
  ...
  <div class="card">
    <img class="card-img-top" src="10.jpg" alt="Card image cap" height="300" width="300">
    <div class="card-body">
  ...
  <div class="card">
    <img class="card-img-top" src="1.jpg" alt="Card image cap" height="300" width="300">
    <div class="card-body">
      <h5 class="card-title">Florists</h5>
      <p class="card-text"></p>
    </div>
    <div class="card-footer">
      <small class="text-muted"></small>
  ...
  <div class="card">
    <img class="card-img-top" src="14.jpg" alt="Card image cap"height="300" width="300">
    <div class="card-body">
      <h5 class="card-title">Bridal Dressing</h5>
      <p class="card-text"></p>
    </div>
    <div class="card-footer">
      <small class="text-muted"></small>
            ...
            <br>
             ...
             <div class="card-group">
  <div class="card">
    <img class="card-img-top" src="7.jpg" alt="Card image cap"height="300" width="300">
    <div class="card-body">
  ...
  <div class="card">
    <img class="card-img-top" src="8.jpg" alt="Card image cap"height="300" width="300">
    <div class="card-body">
  ...
  <div class="card">
    <img class="card-img-top" src="12.jpg" alt="Card image cap"height="300" width="300">
    <div class="card-body">
      <h5 class="card-title">Vehicle Service</h5>
      <p class="card-text"></p>
    </div>
    <div class="card-footer">
      <small class="text-muted"></small>
