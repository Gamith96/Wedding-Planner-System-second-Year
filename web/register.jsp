        ...
        <div class="card-body">
            ...
            <div class="form-group">
              <div class="form-row">
                ...
                <div class="col-md-6">
                  <div class="form-label-group">
                    <input type="password" id="confirmPassword" class="form-control" placeholder="Confirm password" required="required" name="passc">
          ...
          <div class="text-center">
            ...
            <a class="d-block small" href="index.jsp">Go Back</a>
          </div>
        </div>
      </div>
    </div>
