...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand navbar-dark bg-dark static-top">
            ...
            <a class="navbar-brand mr-1" href="SpPostViewServlet">Wedding Bells</a>
            <a class="navbar-brand" href="SpPostViewServlet">
        ...
        <div id="wrapper">
            ...
            <div id="content-wrapper">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Content -->
                    <a class="dropdown-item" href="#" data-toggle="modal" data-target="#addpostmodel">Add Post</a>
                ...
                <div class="container">    
                    <div class="jumbotron">
                        ...
                        <%              // retrieve your list from the request, with casting 
                            ArrayList<SpPostViewBean> list = (ArrayList<SpPostViewBean>) request.getAttribute("postdetails");

                            // print the information about every category of the list
                            for (SpPostViewBean category : list) {
                        ...
                        <form action="PostUploadServlet" method="POST" enctype="multipart/form-data" name="filePart">
                            ...
                            <div class="form-group">
                                <div class="form-label-group">
                                    ...
                                    <textarea class="form-control" rows="5" id="comment" name="postdetails" placeholder="Post Details"></textarea>
                                </div>
                                <br>
