...
<html lang="en">
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand navbar-dark bg-dark static-top">
      ...
      <a class="navbar-brand mr-1" href="admin_home.jsp">Wedding Bells</a>
            ...
            <div class="col-xl-3 col-sm-6 mb-3">
              <div class="card text-white bg-primary o-hidden h-100">
                <div class="card-body">
                  ...
                  <div class="mr-5">Service Provider Requests</div>
                </div>
                <a class="card-footer text-white clearfix small z-1" href="ShowSpRequestDetailsServlet">
